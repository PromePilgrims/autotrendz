...
(async () => {
  ...
  writeFileSync('./inputs/altese.json', JSON.stringify(products, null, 2))
})()
...
function makeUrl(url) {
  return `https://www.altese.com.br/api/catalog_system/pub/products/search/${(new URL(url)).pathname.slice(1)}?compSpecs=true`
}
