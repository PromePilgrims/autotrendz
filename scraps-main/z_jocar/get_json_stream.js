...
async function main() {
  ...
  const writable = fs.createWriteStream('inputs/jocar.csv')
  ...
  objectToRowStream.write(['Name', 'Categories', 'Price', 'Price Without Discount', 'Product Code', 'Available Quantity', 'Suppliers', 'Images', 'Models', 'Description', 'Link'])
